...
export default function App() {
  ...
  // Listen for reset-layout custom event from SettingsPage
  useEffect(() => {
    const handler = () => {
      setSidebarWidth(240);
      setPlayerWidth(256);
    };
    window.addEventListener('vfx-reset-layout', handler);
    return () => window.removeEventListener('vfx-reset-layout', handler);
  }, []);
